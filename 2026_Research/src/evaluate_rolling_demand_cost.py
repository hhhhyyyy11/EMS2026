...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        default=os.path.join(
            PROJECT_ROOT, "results", "lp_baseline", "dynamic_lp_results_minimize_total_cost.csv"
        ),
        help="CSV from optimize_LP.py containing datetime, sBY, and electricity_price columns",
    )
    parser.add_argument(
        "--proposed-monthly-csv",
        default=os.path.join(
            PROJECT_ROOT, "results", "demand_target_lp", "demand_target_monthly_summary.csv"
        ),
    ...
    parser.add_argument(
        ...
        default=os.path.join(
            PROJECT_ROOT, "results", "demand_target_lp", "demand_target_summary.json"
        ),
        help="Annual summary JSON from Dynamic/optimize_demand_target_lp.py",
    )
    parser.add_argument(
        "--output-dir",
        default=os.path.join(PROJECT_ROOT, "results", "rolling_demand_reassessment"),
