...
model.setObjective(sum(s[k] + v[k] + 0.99 * xFC1[k] for k in range(K)), 'minimize')
...
color = ['green', 'blue', 'blue', 'green', 'blue', 'green', 'blue', 'green', 'blue', 'blue', 'red', 'blue', 'blue',
         'red', 'blue', 'green', 'green', 'blue', 'green', 'green']
