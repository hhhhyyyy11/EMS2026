...
#model.setObjective(sum(s[k] + 0.1 * v[k] + 0.001 * xFC1[k] for k in range(K)), 'minimize')
#model.setObjective(sum(s[k] + v[k] +  xFC1[k] for k in range(K)), 'minimize')
...
#
    ...
    # 2025/2/10の範囲のみを表示
    #ax.set_xlim(pd.Timestamp('2025-02-08 04:00:00'), pd.Timestamp('2025-02-08 06:00:00'))
