...
\begin{itemize}
 ...
 \item[\IS] 系統電力S
   ...
   \item[\IB] 単位時間あたりの最大系統買電量 $a^{\rm BY}_{k}$
...
\begin{figure}[h]
 \centering
 \includegraphics[width=140mm]{../bus_BYSL.png}
...
を参照して決定した．また，式(\ref{eq:sMax})における$a^{\rm BY}_{k}$の値については，500kW未満の契約電力であることを踏まえ，「契約電力が450kW以下にな
らなければならない」という制約になる値に設定した．

\begin{figure}[h]
 \centering
 \includegraphics[width=1\textwidth, page=1]{Optimization_Results.pdf} % 幅は適宜調整
...
\begin{figure}[h]
 \centering
 \includegraphics[width=1\textwidth, page=2]{Optimization_Results.pdf} % 幅は適宜調整
...
\begin{figure}[h]
 \centering
 \includegraphics[width=1\textwidth, page=3]{Optimization_Results.pdf} % 幅は適宜調整
 \caption{最適化結果}
...
実際のバッテリーSOCではSOCが100\%になる方向に進んでいるのに対し，本最適化モデルではSOCが0\%になる方向に進んでいることがわかる．
これは，系統から購入する電力を抑えるために，すでに溜まっている蓄電池の電力を使い切ってしまおうとしていることが原因の一つであると考えられる．
また，2025年2月6日の午後などの売電単価が高いタイミングで売電を行ったり，売電単価が高いタイミングを先読みして予め蓄電池に電力を貯めておく
というふるまいも確認できる．
