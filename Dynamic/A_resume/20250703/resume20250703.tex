...
\title{余剰電力を自己託送することを考慮した電力運用最適化モデル}
\author{神戸大学大学院 奥村侑真}
\date{}
...
\begin{equation}
 ...
 - d^{\rm A1}_{k} - d^{\rm B1}_{k} - d^{\rm C1}_{k} - d^{\rm D1}_{k} = 0,
 \hfill
 k=1,\ldots,K
~~
\end{equation}
...
\begin{figure}[h]
 \centering
 \includegraphics[width=140mm]{../figure/tecseed20250703.png}
